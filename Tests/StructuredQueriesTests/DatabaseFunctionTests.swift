  ...
  @Suite struct DatabaseFunctionTests {
    ...
    @Test func jsonObject() {
      ...
      assertQuery(
        ...
        """
        The operation couldn’t be completed. (StructuredQueriesTests.SnapshotTests.DatabaseFunctionTests.$s22StructuredQueriesTests08SnapshotC0V016DatabaseFunctionC0V7isValid0eF0fMp_7isValidfMu_.(unknown context at $109dd1cb4).InvalidInvocation error 1.)
        """
      }
    }
  }
